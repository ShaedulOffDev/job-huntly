...
const RegisterPage = () => {
  return (
    <div className="flex items-center bg-[#F8F8FD]">
      <div className="w-[550px] max-lg:hidden xl:w-[700px] flex-shrink-0 flex justify-center items-end min-h-[60vh] h-full relative">
      ...
      <div className="w-full justify-center flex p-5 bg-white max-lg:py-10 max-lg:bg-gradient-to-t to-[#f8f8fd] from-white">
        <form className="max-w-[500px] w-full">
          <div className="flex justify-center">
            <button type="button" className="bg-slate-200 text-primary font-[600] px-4 py-2">Job Seeker</button>
            <button type="button" className="text-primary font-[600] px-4 py-2">Company</button>
          </div>
          <h2 className="text-4xl font-bold text-center text-text mt-7">Get more opportunities </h2>
          ...
          <div className="flex justify-between gap-3 mt-7 items-center text-gray-400">
            ...
            <p className="flex-shrink-0">Or sign up with email</p>
            <span className="w-1/2 bg-slate-200 h-[1px]"></span>
          </div>
          <label className="mt-7 block">
            <p className="font-[600] text-text">Full name</p>
            <input className="p-4 border outline-none w-full mt-2" type="text" name="name" placeholder="Enter your full name" />
          </label>
          <label className="mt-7 block">
          ...
          <button className="w-full text-center text-white bg-primary p-4 font-semibold mt-7">Continue</button>
          <div className="mt-7 text-gray-600">
            Already have an account?
            <Link className="text-primary ms-2 font-semibold" href={"/login"}>
              Login
            </Link>
          </div>
          <div className="mt-7 text-gray-400">
            By clicking &apos;Continue&apos;, you acknowledge that you have read and accept the
            <Link className="text-primary mx-1" href={"/"}>
              Terms of Service
            </Link>
            and
            <Link className="text-primary mx-1" href={"/"}>
